...
import nb_no from '/assets/localization/languages/nb_no.json'
import nn_no from '/assets/localization/languages/nn_no.json'
...
export class Constants {
  ...
  static readonly LOCALIZATION_LANGUAGES: Record<string, TSunCardTexts> = {
    da, de, en, es, et, fi, fr, hu, it, nb_no, nn_no, nl, pl, 'pt-BR': ptBR, ru, sl, sv
  }
